...
export const resources:Item[]=[
 'Business Automation Playbook','E-Commerce Playbook','Website Development Playbook','AI for Business Playbook','Lead Generation Playbook','Social Media Systems Playbook','Email Automation Playbook','CRM Playbook','Digital Operations Playbook','Template Library','SOP Collection','AI Prompt Pack','Growth Checklists','Client Toolkit'
].map((title,i)=>({slug:title.toLowerCase().replaceAll(' ','-'),title,kicker:i<9?'Free digital playbook':'Ready-to-use toolkit',description:`A focused, practical resource with frameworks, worksheets and implementation prompts for ${title.replace(' Playbook','').toLowerCase()}.`,image:img(['photo-1456513080510-7bf3a84b82f8','photo-1517841905240-472988babdf9','photo-1499750310107-5fef28a66643','photo-1434030216411-0b793f4b4173'][i%4]),tags:i<9?['Free PDF','Practical worksheet','Course pathway']:['Free access','Editable files','Practical tools']}));
